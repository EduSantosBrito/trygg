...
const ErrorDemo = Effect.gen(function* () {
  ...
  return (
    <div className="example-section">
      ...
      <p>
        This page demonstrates the <code>_error.tsx</code> error boundary.
      ...
      <div className="card" style={{ marginTop: "1rem" }}>
        ...
        <p>
          When you click this button, the component will throw an error.
          The global <code>_error.tsx</code> will catch it and display an error page.
        </p>
        <button 
