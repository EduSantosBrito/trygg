...
export const guard = Effect.gen(function* () {
  ...
  // Return nothing to allow access
          ...
          <ul>
            <li>Guards run <strong>before</strong> the component renders</li>
            <li>Return <code>Router.redirect(path)</code> to block and redirect</li>
            <li>Return <code>void</code> (nothing) to allow access</li>
            <li>Guards are automatically loaded from the route file's <code>guard</code> export</li>
          </ul>
        </div>
