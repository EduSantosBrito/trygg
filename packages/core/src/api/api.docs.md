...
Separate contract files and browser bundle optimization are intentionally out of scope for this feature. Contract and handler code live together in `app/api.ts`, and the generated client module is produced at build time rather than being pre-bundled.
