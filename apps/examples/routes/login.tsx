    ...
    return (
      <div className="auth-page">
        ...
        <div className="auth-actions">
          ...
          <button className="btn btn-secondary" onClick={() => setAuth(Option.none())}>
            Logout
          </button>
        </div>
      </div>
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-info">
        ...
        <p>
          This example demonstrates route guards with <code>Router.redirect()</code>.
        </p>
        <ul>
          <li>
            The <Router.Link to="/protected">/protected</Router.Link> route has a guard
          </li>
