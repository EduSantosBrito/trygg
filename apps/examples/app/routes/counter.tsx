...
const CountDisplay = Component.gen(function* (
  ...
  return (
    <span className="count" style={{ color: theme.primary, background: theme.background }}>
      {value}
    </span>
  );
});
...
const CounterButton = Component.gen(function* (
  ...
  return (
    <button onClick={onClick} style={{ color: theme.text }}>
      {label}
    </button>
  );
});
