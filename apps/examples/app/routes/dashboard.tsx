...
const StatCard = Component.gen(function* (
...
const ActivityItem = Component.gen(function* (
  Props: ComponentProps<{
    text: string;
    time: string;
  }>,
...
const ActionButton = Component.gen(function* (
  Props: ComponentProps<{
    label: string;
...
const Header = Component.gen(function* (
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ margin: 0, color: theme.primary, fontSize: "1.5rem" }}>Dashboard</h1>
...
const SectionTitle = Component.gen(function* (Props: ComponentProps<{ title: string }>) {
  ...
  return <h2 style={{ color: theme.text, marginBottom: "1rem" }}>{title}</h2>;
});
