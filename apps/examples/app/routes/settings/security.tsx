  ...
  return (
    <div className="settings-page">
      ...
      <div className="settings-section">
        ...
        <button type="button" onClick={() => Effect.log("Change password dialog")}>
          Change Password
        </button>
      </div>
      ...
      <div className="settings-section">
        ...
        <div className="toggle-row">
          ...
          <button type="button" onClick={() => Signal.update(twoFactorEnabled, (v) => !v)}>
      ...
      <div className="settings-section">
        ...
        <button type="button" onClick={() => Effect.log("View sessions")}>
          View All Sessions
        </button>
      </div>
    </div>
